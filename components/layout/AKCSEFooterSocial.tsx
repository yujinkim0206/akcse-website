export default function SNSAKCSE() {
  return (
    <div className="flex gap-1.75">
      <a href="https://www.akcse.ca/" target="_blank" rel="noopener noreferrer">
        <svg
      ...
      <a
        href="https://www.linkedin.com/company/association-of-korean-canadian-scientists-&-engineers/"
        target="_blank"
