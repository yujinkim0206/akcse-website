...
export default function ScrollingCards() {
  ...
  return (
    <section className="overflow-hidden section-spacing">
      <div
        className="flex w-max h-[var(--card-height)] sm:h-[var(--card-height-hover)] animate-[marquee_linear_infinite] items-center justify-center will-change-transform"
      ...
      >
        {doubled.map((item, i) => (
          <div
            key={i}
            className="relative aspect-[3/4] h-[var(--card-height)] shrink-0 overflow-hidden transition-[height] duration-300 sm:hover:h-[var(--card-height-hover)]"
          >
